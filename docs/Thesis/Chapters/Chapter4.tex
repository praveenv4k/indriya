...
\end{tabular}
\end{table}
\subsection*{Context orchestrator} The orchestrator collect uptodate information about the robots and humans in the environment from the perception system and updates the Application context. The algorithm used by the orchestrator to update the context information is shown below.
...
The robot interface node implements a Finite state machine (Fig.~\ref{fig:robot_fsm}) in order appropriately streamline the data/status management with the remote caller node. The states of the FSM are
\begin{itemize}[leftmargin={1cm},topsep={0pt},itemsep={0pt},partopsep={0pt},parsep={0pt}] 
...
\label{ssec:ui_comp}
The user interface is a web application that runs on any latest web-kit browsers supporting HTML5, CSS3 and WebGL technologies. The list of libraries and components used to build the web interface has been described in Section~\ref{sec:ui_design}. In this section the various screens in the developed user interface has been described. 
\begin{figure}[H]
\centering
\begin{tikzpicture}
...
\end{itemize}
% %\begin{table}[H]
% \begin{longtable}[H]{|p{3cm}|r|p{8cm}|}
% %\centering
% %\small
% %\caption{Implemented blocks}
% %\label{table:toolbox_blocks}
% %\begin{tabular}{|p{3cm}|r|p{8cm}|}
%   \hline
%     \multicolumn{3}{|c|}{Nao action blocks}\\
%     \hline
%     \multirow{4}{*}{Move straight}& {} & {} \\
%                              & Visual & \parbox[c]{1em}{\includegraphics[width=4cm]{../thesis/assets/blocks/nao_move.png}} \\
%                              & Description & The robot moves straight for the specified distance. \\
%                              & Parameters & \begin{itemize} \item Distance in metres \item Name/Id of robot \end{itemize} \\
%     \hline
%     \multirow{4}{*}{Turn}& {} & {} \\
%                              & Visual & \parbox[c]{1em}{\includegraphics[width=4cm]{../thesis/assets/blocks/nao_turn.png}} \\
%                              & Description & The robot turn towards the direction specified \\
%                              & Parameters & \begin{itemize} \item Direction: Left, Right, Around \item Name/Id of robot \end{itemize} \\
%     \hline
%     \multirow{4}{*}{Approach}& {} & {} \\
%                              & Visual & \parbox[c]{1em}{\includegraphics[width=8cm]{../thesis/assets/blocks/nao_approach.png}} \\
...
%                              & Parameters & \begin{itemize} \item Distance threshold in metres \item Name/Id of robot \end{itemize} \\

%     \hline
%     \multirow{4}{*}{Standard action}& {} & {} \\
%                              & Visual & \parbox[c]{1em}{\includegraphics[width=4cm]{../thesis/assets/blocks/nao_behavior.png}} \\
%                              & Description & The robot performs certain standard actions \\
%                              & Parameters & \begin{itemize} \item Action name: Greet, Stand, Sit etc., \item Name/Id of robot \end{itemize} \\

%     \hline
%     \multirow{4}{*}{Say}& {} & {} \\
%                              & Visual & \parbox[c]{1em}{\includegraphics[width=8cm]{../thesis/assets/blocks/nao_say.png}} \\
%                              & Description & The robot speaks the input text expressively (using hand and head motions)  \\
%                              & Parameters & \begin{itemize} \item Text to speak \item Name/Id of robot \end{itemize} \\

%     \hline
%     \multirow{4}{*}{Say with argument}& {} & {} \\
...
%                              & Parameters & \begin{itemize} \item Prefix/Suffix text with variable placeholder \item Name/Id of robot \end{itemize} \\

%     % {} & {} \\
%     % Block&\parbox[c]{1em}{\includegraphics[width=5in]{../thesis/assets/blocks/nao_approach.png}} \\
%     % \hline
%     % Description& The signal that activates the behavior block. The trigger source could be either of human presence/absence, motion gesture, vicinity of human, verbal command or any boolean edge trigger. \\
%     % \hline
%     % Parameters& {} \\
%     \hline
...
% \end{longtable}
%\begin{table}[H]
\begin{longtable}[H]{|r|p{12cm}|}
    \hline
    \multicolumn{2}{|c|}{Trigger blocks}\\
    \hline
     {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=5cm]{../thesis/assets/blocks/triggers_gesture.png}} \\
    ...
    \hline
    {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=5cm]{../thesis/assets/blocks/triggers_speech1.png}} \\
                             {} & \parbox[c]{1em}{\includegraphics[width=5cm]{../thesis/assets/blocks/triggers_speech2.png}} \\
                             Name   & Voice trigger \\
    ...
    \hline
     {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=7cm]{../thesis/assets/blocks/nao_move.png}} \\
    ...
    \hline
    {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=6cm]{../thesis/assets/blocks/nao_turn.png}} \\
                             Name   & Turn action \\
                             Description & The robot turn towards the direction specified \\
    ...
    \hline
    {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=11cm]{../thesis/assets/blocks/nao_approach.png}} \\
    ...
    \hline
    {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=6cm]{../thesis/assets/blocks/nao_behavior.png}} \\
    ...
    \hline
    {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=7cm]{../thesis/assets/blocks/nao_say.png}} \\
    ...
    \hline
    {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=2.5cm]{../thesis/assets/blocks/nao_rest.png}} \\
                             Name   & Rest \\
    ...
    \hline
     {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=4cm]{../thesis/assets/blocks/speech_wait.png}} \\
    ...
    \hline
     {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=6cm]{../thesis/assets/blocks/console_print.png}} \\
                             Name   & Console print \\
                             Description & To print a debugging message in the terminal during program execution \\
                             Parameters & 1. Message to print \\ 
    \hline
    {} & {} \\
                             Visual & \parbox[c]{1em}{\includegraphics[width=3cm]{../thesis/assets/blocks/sleep.png}} \\
                             Name   & Sleep \\
