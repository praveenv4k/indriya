...
%\begin{tabularx}{560pt}{c|*6{>{\Centering}X}}
\begin{table}
\scriptsize
...
\toprule
  ...
  %\multicolumn{1}{l}{Viewing Angle- FOV}  & Vertical $43^{\circ}$; Horizontal $57^{\circ}$
  ...
  %\multicolumn{1}{l}{Skeleton Joints defined} & 20, 2 skeloton
  ...
  \multicolumn{1}{l}{Range (m)}           & Min: 0.4; Max $\approx$ 4.5 
  										 ...
  										 & Min: 0.8; Max: 3.5
  										 & Min: 0.4; Max: 3.5  %Infrared structured light projector, Uniform infrared LEDs
  										 & Min: 0.5 cm; Max: 3.25 m % Laser, 3D depth sensor
  ...
  \multicolumn{1}{l}{OS}                  & Win 7, Win 8
  										 & Win 8
  										 %& Win XP,Vista,7,8; Ubuntu 10.10, Android(by request)
...
%  \multicolumn{1}{l}{Audio Format}        &  16 KHz, 24-bit Mono PCM
%  										 &  48 KHz, 24-bit Mono PCM
%  										 &  -
%  										 &  - 
%  										 & 47 
%  										 & 4 
%  										 \tabularnewline\midrule
  ...
  \multicolumn{1}{l}{Audio Input}        &  Microphone array-4, 16 KHz, Mono PCM, 24 bit ADC, Echo cancellation        											and noise suppression 
  										...
  										\tabularnewline
  										%\midrule
%  										 										 				 				  \multicolumn{1}{l}{Accelerometer}      &  2G/4G/8G accelerometer 
%  										& - 
%  										&  -
%  										&  7 
%  										& 47 
