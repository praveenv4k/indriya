...
Humans interacting with intelligent robots has been seen as a potential game changer of the future. In scenarios where robots coexist with humans in a social environment, understanding both verbal and non-verbal communication is extremely inevitable. Together they convey information such as intention, emotion and even health of a human, that adds value to the way robots participate in an interaction. Additionally, the people who design interaction scenarios are from diverse fields who do not essentially have the required robot programming skills. In this thesis we propose a new behavior programming paradigm and an easy to use programming interface for the same, which give the power to design robot behaviors taking into account human behaviors. We propose a distributed system namely Indriya, which gives the capability to plug and play multi-modal activity recognition systems and diverse class of robots. We present results of NAO humanoid robot performing actions understanding human behavior using Microsoft Kinect gesture/speech recognition system.
}
