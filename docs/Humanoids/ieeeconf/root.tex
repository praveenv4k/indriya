...
\begin{figure}
\centering
\includegraphics[width=0.6\columnwidth]{../../thesis/assets/scenario_museum_text.eps}
...
The textual representation of Indriya program is shown in Fig.~\ref{fig:scenario1_program} for clarity. The platform equipped with Kinect sensor takes care of the detection of people and gives the relative localization of the robot and human. Once the person is detected or a configured gesture trigger arrives, the behavior program retrieves the relative transformation of the robot with respect to human. The \emph{Approach block} makes use of this information to drive the robot towards the person. After coming into the proximity of the person, the robot starts explaining the history of museum configure. From the user perspective, the design of the behavior is \emph{intuitive} using Indriya. He/She can focus on the scenario rather than thinking about the minute details of the data flow. 
\section{USER STUDY}
