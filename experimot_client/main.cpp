...
#include <experimot\msgs\vector3d.pb.h>
...
int main(void)
{
	...
	experimot::msgs::MsgFactory::GetMsgTypes(msg_types);
	for (std::vector<std::string>::iterator it = msg_types.begin(); it != msg_types.end(); ++it){
