...
using ExperimotStudio.Modules.Home.Views;
...
namespace ExperimotStudio.Modules.Home.ViewModels
{
    ...
    public class HelixViewModel : Document
    {
        ...
        protected override void OnViewLoaded(object view)
        {
            ...
            _helixView.TextEditor.Text = @"public class MyClass : ExperimotStudio.Modules.Home.ViewModels.IDemoScript
{
    public void Execute(ExperimotStudio.Modules.Home.ViewModels.HelixViewModel viewModel)
    {
