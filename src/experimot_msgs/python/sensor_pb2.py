...
_SENSOR = _descriptor.Descriptor(
  name='Sensor',
  full_name='experimot.msgs.Sensor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='experimot.msgs.Sensor.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='id', full_name='experimot.msgs.Sensor.id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='parent', full_name='experimot.msgs.Sensor.parent', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='parent_id', full_name='experimot.msgs.Sensor.parent_id', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='experimot.msgs.Sensor.type', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='always_on', full_name='experimot.msgs.Sensor.always_on', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='update_rate', full_name='experimot.msgs.Sensor.update_rate', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pose', full_name='experimot.msgs.Sensor.pose', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='camera', full_name='experimot.msgs.Sensor.camera', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ray', full_name='experimot.msgs.Sensor.ray', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='contact', full_name='experimot.msgs.Sensor.contact', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='visualize', full_name='experimot.msgs.Sensor.visualize', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='topic', full_name='experimot.msgs.Sensor.topic', index=12,
