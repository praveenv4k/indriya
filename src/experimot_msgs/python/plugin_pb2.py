...
_PLUGIN = _descriptor.Descriptor(
  name='Plugin',
  full_name='experimot.msgs.Plugin',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='experimot.msgs.Plugin.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='filename', full_name='experimot.msgs.Plugin.filename', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='innerxml', full_name='experimot.msgs.Plugin.innerxml', index=2,
