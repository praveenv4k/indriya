...
_SKY = _descriptor.Descriptor(
  name='Sky',
  full_name='experimot.msgs.Sky',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='experimot.msgs.Sky.time', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sunrise', full_name='experimot.msgs.Sky.sunrise', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sunset', full_name='experimot.msgs.Sky.sunset', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wind_speed', full_name='experimot.msgs.Sky.wind_speed', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wind_direction', full_name='experimot.msgs.Sky.wind_direction', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cloud_ambient', full_name='experimot.msgs.Sky.cloud_ambient', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='humidity', full_name='experimot.msgs.Sky.humidity', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mean_cloud_size', full_name='experimot.msgs.Sky.mean_cloud_size', index=7,
