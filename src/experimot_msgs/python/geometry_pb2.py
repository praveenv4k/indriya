...
_GEOMETRY_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='experimot.msgs.Geometry.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GEOMETRY = _descriptor.Descriptor(
  name='Geometry',
  full_name='experimot.msgs.Geometry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='experimot.msgs.Geometry.type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='box', full_name='experimot.msgs.Geometry.box', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cylinder', full_name='experimot.msgs.Geometry.cylinder', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='plane', full_name='experimot.msgs.Geometry.plane', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sphere', full_name='experimot.msgs.Geometry.sphere', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image', full_name='experimot.msgs.Geometry.image', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='heightmap', full_name='experimot.msgs.Geometry.heightmap', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mesh', full_name='experimot.msgs.Geometry.mesh', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='points', full_name='experimot.msgs.Geometry.points', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='polyline', full_name='experimot.msgs.Geometry.polyline', index=9,
