...
_FRICTION = _descriptor.Descriptor(
  name='Friction',
  full_name='experimot.msgs.Friction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mu', full_name='experimot.msgs.Friction.mu', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mu2', full_name='experimot.msgs.Friction.mu2', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fdir1', full_name='experimot.msgs.Friction.fdir1', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='slip1', full_name='experimot.msgs.Friction.slip1', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='slip2', full_name='experimot.msgs.Friction.slip2', index=4,
