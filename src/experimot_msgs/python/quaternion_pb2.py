...
_QUATERNION = _descriptor.Descriptor(
  name='Quaternion',
  full_name='experimot.msgs.Quaternion',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='experimot.msgs.Quaternion.x', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='y', full_name='experimot.msgs.Quaternion.y', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='z', full_name='experimot.msgs.Quaternion.z', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='w', full_name='experimot.msgs.Quaternion.w', index=3,
