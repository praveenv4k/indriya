...
_PROJECTOR = _descriptor.Descriptor(
  name='Projector',
  full_name='experimot.msgs.Projector',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='experimot.msgs.Projector.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='texture', full_name='experimot.msgs.Projector.texture', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pose', full_name='experimot.msgs.Projector.pose', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fov', full_name='experimot.msgs.Projector.fov', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='near_clip', full_name='experimot.msgs.Projector.near_clip', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='far_clip', full_name='experimot.msgs.Projector.far_clip', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='enabled', full_name='experimot.msgs.Projector.enabled', index=6,
