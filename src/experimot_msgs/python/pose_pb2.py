...
_POSE = _descriptor.Descriptor(
  name='Pose',
  full_name='experimot.msgs.Pose',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='experimot.msgs.Pose.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='id', full_name='experimot.msgs.Pose.id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='position', full_name='experimot.msgs.Pose.position', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='orientation', full_name='experimot.msgs.Pose.orientation', index=3,
