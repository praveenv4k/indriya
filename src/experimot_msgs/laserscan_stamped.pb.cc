...
void protobuf_AssignDesc_laserscan_5fstamped_2eproto() {
  ...
  LaserScanStamped_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LaserScanStamped, _internal_metadata_),
      -1);
}
...
LaserScanStamped* LaserScanStamped::New(::google::protobuf::Arena* arena) const {
  LaserScanStamped* n = new LaserScanStamped;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
int LaserScanStamped::RequiredFieldsByteSizeFallback() const {
  int total_size = 0;
...
// required .experimot.msgs.Time time = 1;
 ...
 void LaserScanStamped::set_has_time() {
  _has_bits_[0] |= 0x00000001u;
}
 void LaserScanStamped::clear_has_time() {
  _has_bits_[0] &= ~0x00000001u;
}
...
// required .experimot.msgs.LaserScan scan = 2;
 ...
 void LaserScanStamped::set_has_scan() {
  _has_bits_[0] |= 0x00000002u;
}
 void LaserScanStamped::clear_has_scan() {
  _has_bits_[0] &= ~0x00000002u;
}
