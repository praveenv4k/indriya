...
define([
        'app', 'backbone', 'marionette', 'models/robot', 'models/testjointvalues', 'models/JointValues', 'collections/drawables', 'collections/skeletons', 'marionette_threejs', 'poller',
        ...
        return backbone.Marionette.Controller.extend({
            initialize: function(options) {
                ...
                app.robotpoller.on('error', function(model) {
                    globalCh.vent.trigger("IndriyaCommunication", false);
                    console.error('Communication interuption with indriya application!');
                });
