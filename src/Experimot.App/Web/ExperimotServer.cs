...
namespace Experimot.Scheduler.Web
{
    public class ExperimotServer : IDisposable
    {
        ...
        public void Start()
        {
            ...
            var port = ParameterUtil.Get(_config.parameters, "WebServerPort", 82);
            ...
            FileHandler.HttpRootDirectory = @"C:\Work\Develop\src\github\ExPeriMot\src\Experimot.Scheduler\Web\www";
            _server.Use(fileHandler);
