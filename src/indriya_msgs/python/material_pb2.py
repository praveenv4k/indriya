...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  #syntax='proto2',
  serialized_pb=_b('\n\x0ematerial.proto\x12\x11Indriya.Core.Msgs\x1a\x0b\x63olor.proto\"\xd4\x03\n\x08Material\x12\x32\n\x06script\x18\x01 \x01(\x0b\x32\".Indriya.Core.Msgs.Material.Script\x12;\n\x0bshader_type\x18\x02 \x01(\x0e\x32&.Indriya.Core.Msgs.Material.ShaderType\x12\x12\n\nnormal_map\x18\x03 \x01(\t\x12)\n\x07\x61mbient\x18\x04 \x01(\x0b\x32\x18.Indriya.Core.Msgs.Color\x12)\n\x07\x64iffuse\x18\x05 \x01(\x0b\x32\x18.Indriya.Core.Msgs.Color\x12*\n\x08specular\x18\x06 \x01(\x0b\x32\x18.Indriya.Core.Msgs.Color\x12*\n\x08\x65missive\x18\x07 \x01(\x0b\x32\x18.Indriya.Core.Msgs.Color\x12\x10\n\x08lighting\x18\x08 \x01(\x08\x1a#\n\x06Script\x12\x0b\n\x03uri\x18\x01 \x03(\t\x12\x0c\n\x04name\x18\x02 \x02(\t\"^\n\nShaderType\x12\n\n\x06VERTEX\x10\x01\x12\t\n\x05PIXEL\x10\x02\x12\x1b\n\x17NORMAL_MAP_OBJECT_SPACE\x10\x03\x12\x1c\n\x18NORMAL_MAP_TANGENT_SPACE\x10\x04')
  ,
...
_MATERIAL_SHADERTYPE = _descriptor.EnumDescriptor(
  name='ShaderType',
  full_name='Indriya.Core.Msgs.Material.ShaderType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_MATERIAL_SCRIPT = _descriptor.Descriptor(
  name='Script',
  full_name='Indriya.Core.Msgs.Material.Script',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='Indriya.Core.Msgs.Material.Script.uri', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='Indriya.Core.Msgs.Material.Script.name', index=1,
...
_MATERIAL = _descriptor.Descriptor(
  name='Material',
  full_name='Indriya.Core.Msgs.Material',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='script', full_name='Indriya.Core.Msgs.Material.script', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shader_type', full_name='Indriya.Core.Msgs.Material.shader_type', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='normal_map', full_name='Indriya.Core.Msgs.Material.normal_map', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ambient', full_name='Indriya.Core.Msgs.Material.ambient', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='diffuse', full_name='Indriya.Core.Msgs.Material.diffuse', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='specular', full_name='Indriya.Core.Msgs.Material.specular', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='emissive', full_name='Indriya.Core.Msgs.Material.emissive', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lighting', full_name='Indriya.Core.Msgs.Material.lighting', index=7,
