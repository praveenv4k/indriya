...
_MATERIAL_SHADERTYPE = _descriptor.EnumDescriptor(
  name='ShaderType',
  full_name='experimot.msgs.Material.ShaderType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_MATERIAL_SCRIPT = _descriptor.Descriptor(
  name='Script',
  full_name='experimot.msgs.Material.Script',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='experimot.msgs.Material.Script.uri', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='experimot.msgs.Material.Script.name', index=1,
...
_MATERIAL = _descriptor.Descriptor(
  name='Material',
  full_name='experimot.msgs.Material',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='script', full_name='experimot.msgs.Material.script', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shader_type', full_name='experimot.msgs.Material.shader_type', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='normal_map', full_name='experimot.msgs.Material.normal_map', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ambient', full_name='experimot.msgs.Material.ambient', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='diffuse', full_name='experimot.msgs.Material.diffuse', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='specular', full_name='experimot.msgs.Material.specular', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='emissive', full_name='experimot.msgs.Material.emissive', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lighting', full_name='experimot.msgs.Material.lighting', index=7,
