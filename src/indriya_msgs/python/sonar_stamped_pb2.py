...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  #syntax='proto2',
  serialized_pb=_b('\n\x13sonar_stamped.proto\x12\x11Indriya.Core.Msgs\x1a\ntime.proto\x1a\x0bsonar.proto\"^\n\x0cSonarStamped\x12%\n\x04time\x18\x01 \x02(\x0b\x32\x17.Indriya.Core.Msgs.Time\x12\'\n\x05sonar\x18\x02 \x02(\x0b\x32\x18.Indriya.Core.Msgs.Sonar')
  ,
...
_SONARSTAMPED = _descriptor.Descriptor(
  name='SonarStamped',
  full_name='Indriya.Core.Msgs.SonarStamped',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='Indriya.Core.Msgs.SonarStamped.time', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sonar', full_name='Indriya.Core.Msgs.SonarStamped.sonar', index=1,
