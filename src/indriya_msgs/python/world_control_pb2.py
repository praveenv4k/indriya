...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  #syntax='proto2',
  serialized_pb=_b('\n\x13world_control.proto\x12\x11Indriya.Core.Msgs\x1a\x11world_reset.proto\"{\n\x0cWorldControl\x12\r\n\x05pause\x18\x01 \x01(\x08\x12\x0c\n\x04step\x18\x02 \x01(\x08\x12\x12\n\nmulti_step\x18\x03 \x01(\r\x12,\n\x05reset\x18\x04 \x01(\x0b\x32\x1d.Indriya.Core.Msgs.WorldReset\x12\x0c\n\x04seed\x18\x05 \x01(\r')
  ,
...
_WORLDCONTROL = _descriptor.Descriptor(
  name='WorldControl',
  full_name='Indriya.Core.Msgs.WorldControl',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pause', full_name='Indriya.Core.Msgs.WorldControl.pause', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='step', full_name='Indriya.Core.Msgs.WorldControl.step', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='multi_step', full_name='Indriya.Core.Msgs.WorldControl.multi_step', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reset', full_name='Indriya.Core.Msgs.WorldControl.reset', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='seed', full_name='Indriya.Core.Msgs.WorldControl.seed', index=4,
