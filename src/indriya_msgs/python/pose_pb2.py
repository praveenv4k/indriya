...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  #syntax='proto2',
  serialized_pb=_b('\n\npose.proto\x12\x11Indriya.Core.Msgs\x1a\x0evector3d.proto\x1a\x10quaternion.proto\"\x83\x01\n\x04Pose\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\n\n\x02id\x18\x02 \x01(\r\x12-\n\x08position\x18\x03 \x02(\x0b\x32\x1b.Indriya.Core.Msgs.Vector3d\x12\x32\n\x0borientation\x18\x04 \x02(\x0b\x32\x1d.Indriya.Core.Msgs.Quaternion')
  ,
...
_POSE = _descriptor.Descriptor(
  name='Pose',
  full_name='Indriya.Core.Msgs.Pose',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Indriya.Core.Msgs.Pose.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='id', full_name='Indriya.Core.Msgs.Pose.id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='position', full_name='Indriya.Core.Msgs.Pose.position', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='orientation', full_name='Indriya.Core.Msgs.Pose.orientation', index=3,
