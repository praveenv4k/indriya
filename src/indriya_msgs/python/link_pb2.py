...
_LINK = _descriptor.Descriptor(
  name='Link',
  full_name='experimot.msgs.Link',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='experimot.msgs.Link.id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='experimot.msgs.Link.name', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='self_collide', full_name='experimot.msgs.Link.self_collide', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gravity', full_name='experimot.msgs.Link.gravity', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='kinematic', full_name='experimot.msgs.Link.kinematic', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='enabled', full_name='experimot.msgs.Link.enabled', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='inertial', full_name='experimot.msgs.Link.inertial', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pose', full_name='experimot.msgs.Link.pose', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='visual', full_name='experimot.msgs.Link.visual', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='collision', full_name='experimot.msgs.Link.collision', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sensor', full_name='experimot.msgs.Link.sensor', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='projector', full_name='experimot.msgs.Link.projector', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='canonical', full_name='experimot.msgs.Link.canonical', index=12,
