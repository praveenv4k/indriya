...
_JOINTWRENCH = _descriptor.Descriptor(
  name='JointWrench',
  full_name='experimot.msgs.JointWrench',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='body_1_name', full_name='experimot.msgs.JointWrench.body_1_name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='body_1_id', full_name='experimot.msgs.JointWrench.body_1_id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='body_2_name', full_name='experimot.msgs.JointWrench.body_2_name', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='body_2_id', full_name='experimot.msgs.JointWrench.body_2_id', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='body_1_wrench', full_name='experimot.msgs.JointWrench.body_1_wrench', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='body_2_wrench', full_name='experimot.msgs.JointWrench.body_2_wrench', index=5,
