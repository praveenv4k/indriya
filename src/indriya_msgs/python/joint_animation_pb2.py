...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  #syntax='proto2',
  serialized_pb=_b('\n\x15joint_animation.proto\x12\x11Indriya.Core.Msgs\x1a\ntime.proto\"\xa9\x01\n\x0eJointAnimation\x12\x12\n\nmodel_name\x18\x01 \x02(\t\x12\x36\n\x05joint\x18\x02 \x03(\x0b\x32\'.Indriya.Core.Msgs.JointAnimation.Joint\x12%\n\x04time\x18\x03 \x03(\x0b\x32\x17.Indriya.Core.Msgs.Time\x1a$\n\x05Joint\x12\x0c\n\x04name\x18\x01 \x03(\t\x12\r\n\x05\x61ngle\x18\x02 \x03(\x01')
  ,
...
_JOINTANIMATION_JOINT = _descriptor.Descriptor(
  name='Joint',
  full_name='Indriya.Core.Msgs.JointAnimation.Joint',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Indriya.Core.Msgs.JointAnimation.Joint.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='angle', full_name='Indriya.Core.Msgs.JointAnimation.Joint.angle', index=1,
...
_JOINTANIMATION = _descriptor.Descriptor(
  name='JointAnimation',
  full_name='Indriya.Core.Msgs.JointAnimation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='model_name', full_name='Indriya.Core.Msgs.JointAnimation.model_name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='joint', full_name='Indriya.Core.Msgs.JointAnimation.joint', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='time', full_name='Indriya.Core.Msgs.JointAnimation.time', index=2,
