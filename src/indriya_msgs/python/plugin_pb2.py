...
_PLUGIN = _descriptor.Descriptor(
  name='Plugin',
  full_name='Indriya.Core.Msgs.Plugin',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Indriya.Core.Msgs.Plugin.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='filename', full_name='Indriya.Core.Msgs.Plugin.filename', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='innerxml', full_name='Indriya.Core.Msgs.Plugin.innerxml', index=2,
