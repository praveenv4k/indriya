...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  #syntax='proto2',
  serialized_pb=_b('\n\x13image_stamped.proto\x12\x11Indriya.Core.Msgs\x1a\ntime.proto\x1a\x0bimage.proto\"^\n\x0cImageStamped\x12%\n\x04time\x18\x01 \x02(\x0b\x32\x17.Indriya.Core.Msgs.Time\x12\'\n\x05image\x18\x02 \x02(\x0b\x32\x18.Indriya.Core.Msgs.Image')
  ,
...
_IMAGESTAMPED = _descriptor.Descriptor(
  name='ImageStamped',
  full_name='Indriya.Core.Msgs.ImageStamped',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='Indriya.Core.Msgs.ImageStamped.time', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image', full_name='Indriya.Core.Msgs.ImageStamped.image', index=1,
