...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  #syntax='proto2',
  serialized_pb=_b('\n\x13image_stamped.proto\x12\x0e\x65xperimot.msgs\x1a\ntime.proto\x1a\x0bimage.proto\"X\n\x0cImageStamped\x12\"\n\x04time\x18\x01 \x02(\x0b\x32\x14.experimot.msgs.Time\x12$\n\x05image\x18\x02 \x02(\x0b\x32\x15.experimot.msgs.Image')
  ,
...
_IMAGESTAMPED = _descriptor.Descriptor(
  name='ImageStamped',
  full_name='experimot.msgs.ImageStamped',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='experimot.msgs.ImageStamped.time', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image', full_name='experimot.msgs.ImageStamped.image', index=1,
