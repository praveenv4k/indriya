...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  #syntax='proto2',
  serialized_pb=_b('\n\x0egeometry.proto\x12\x11Indriya.Core.Msgs\x1a\rboxgeom.proto\x1a\x12\x63ylindergeom.proto\x1a\x10spheregeom.proto\x1a\x0fplanegeom.proto\x1a\x0fimagegeom.proto\x1a\x13heightmapgeom.proto\x1a\x0emeshgeom.proto\x1a\x0evector3d.proto\x1a\x12polylinegeom.proto\"\xf1\x04\n\x08Geometry\x12.\n\x04type\x18\x01 \x01(\x0e\x32 .Indriya.Core.Msgs.Geometry.Type\x12\'\n\x03\x62ox\x18\x02 \x01(\x0b\x32\x1a.Indriya.Core.Msgs.BoxGeom\x12\x31\n\x08\x63ylinder\x18\x03 \x01(\x0b\x32\x1f.Indriya.Core.Msgs.CylinderGeom\x12+\n\x05plane\x18\x04 \x01(\x0b\x32\x1c.Indriya.Core.Msgs.PlaneGeom\x12-\n\x06sphere\x18\x05 \x01(\x0b\x32\x1d.Indriya.Core.Msgs.SphereGeom\x12+\n\x05image\x18\x06 \x01(\x0b\x32\x1c.Indriya.Core.Msgs.ImageGeom\x12\x33\n\theightmap\x18\x07 \x01(\x0b\x32 .Indriya.Core.Msgs.HeightmapGeom\x12)\n\x04mesh\x18\x08 \x01(\x0b\x32\x1b.Indriya.Core.Msgs.MeshGeom\x12+\n\x06points\x18\t \x03(\x0b\x32\x1b.Indriya.Core.Msgs.Vector3d\x12-\n\x08polyline\x18\n \x03(\x0b\x32\x1b.Indriya.Core.Msgs.Polyline\"\x93\x01\n\x04Type\x12\x07\n\x03\x42OX\x10\x01\x12\x0c\n\x08\x43YLINDER\x10\x02\x12\n\n\x06SPHERE\x10\x03\x12\t\n\x05PLANE\x10\x04\x12\t\n\x05IMAGE\x10\x05\x12\r\n\tHEIGHTMAP\x10\x06\x12\x08\n\x04MESH\x10\x07\x12\x10\n\x0cTRIANGLE_FAN\x10\x08\x12\x0e\n\nLINE_STRIP\x10\t\x12\x0c\n\x08POLYLINE\x10\n\x12\t\n\x05\x45MPTY\x10\x0b')
  ,
...
_GEOMETRY_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='Indriya.Core.Msgs.Geometry.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GEOMETRY = _descriptor.Descriptor(
  name='Geometry',
  full_name='Indriya.Core.Msgs.Geometry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='Indriya.Core.Msgs.Geometry.type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='box', full_name='Indriya.Core.Msgs.Geometry.box', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cylinder', full_name='Indriya.Core.Msgs.Geometry.cylinder', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='plane', full_name='Indriya.Core.Msgs.Geometry.plane', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sphere', full_name='Indriya.Core.Msgs.Geometry.sphere', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image', full_name='Indriya.Core.Msgs.Geometry.image', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='heightmap', full_name='Indriya.Core.Msgs.Geometry.heightmap', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mesh', full_name='Indriya.Core.Msgs.Geometry.mesh', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='points', full_name='Indriya.Core.Msgs.Geometry.points', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='polyline', full_name='Indriya.Core.Msgs.Geometry.polyline', index=9,
