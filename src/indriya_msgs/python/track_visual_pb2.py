...
_TRACKVISUAL = _descriptor.Descriptor(
  name='TrackVisual',
  full_name='Indriya.Core.Msgs.TrackVisual',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Indriya.Core.Msgs.TrackVisual.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='id', full_name='Indriya.Core.Msgs.TrackVisual.id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='inherit_orientation', full_name='Indriya.Core.Msgs.TrackVisual.inherit_orientation', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_dist', full_name='Indriya.Core.Msgs.TrackVisual.min_dist', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_dist', full_name='Indriya.Core.Msgs.TrackVisual.max_dist', index=4,
