...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  #syntax='proto2',
  serialized_pb=_b('\n\x0evector2d.proto\x12\x11Indriya.Core.Msgs\" \n\x08Vector2d\x12\t\n\x01x\x18\x01 \x02(\x01\x12\t\n\x01y\x18\x02 \x02(\x01')
)
...
_VECTOR2D = _descriptor.Descriptor(
  name='Vector2d',
  full_name='Indriya.Core.Msgs.Vector2d',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='Indriya.Core.Msgs.Vector2d.x', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='y', full_name='Indriya.Core.Msgs.Vector2d.y', index=1,
