...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  #syntax='proto2',
  serialized_pb=_b('\n\x0fplanegeom.proto\x12\x11Indriya.Core.Msgs\x1a\x0evector3d.proto\x1a\x0evector2d.proto\"q\n\tPlaneGeom\x12+\n\x06normal\x18\x01 \x02(\x0b\x32\x1b.Indriya.Core.Msgs.Vector3d\x12)\n\x04size\x18\x02 \x02(\x0b\x32\x1b.Indriya.Core.Msgs.Vector2d\x12\x0c\n\x01\x64\x18\x03 \x01(\x01:\x01\x30')
  ,
...
_PLANEGEOM = _descriptor.Descriptor(
  name='PlaneGeom',
  full_name='Indriya.Core.Msgs.PlaneGeom',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='normal', full_name='Indriya.Core.Msgs.PlaneGeom.normal', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='size', full_name='Indriya.Core.Msgs.PlaneGeom.size', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='d', full_name='Indriya.Core.Msgs.PlaneGeom.d', index=2,
