...
_COLOR = _descriptor.Descriptor(
  name='Color',
  full_name='Indriya.Core.Msgs.Color',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='r', full_name='Indriya.Core.Msgs.Color.r', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='g', full_name='Indriya.Core.Msgs.Color.g', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='b', full_name='Indriya.Core.Msgs.Color.b', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='a', full_name='Indriya.Core.Msgs.Color.a', index=3,
