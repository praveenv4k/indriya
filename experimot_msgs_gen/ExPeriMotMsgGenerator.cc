...
#include "ExPeriMotMsgGenerator.hh"
...
ExPeriMotMsgGenerator::ExPeriMotMsgGenerator(const std::string &/*_name*/) {}
ExPeriMotMsgGenerator::~ExPeriMotMsgGenerator() {}
bool ExPeriMotMsgGenerator::Generate(const FileDescriptor *_file,
                               ...
                               std::string * /*_error*/) const
{
  ...
  // Add boost shared point include
  {
    ...
    //printer.Print("#pragma GCC diagnostic ignored \"-Wshadow\"", "name","includes");
  }
...

  {
    ...
    printer.Print("#include \"MsgFactory.h\"\n",
        "name", "includes");
  }
  ...
  // Add Message Factory register
  {
    ...
    std::string constType = "EX_REGISTER_STATIC_MSG(\"" + _file->package() +
      "." + name + "\", " + name + ")\n";
