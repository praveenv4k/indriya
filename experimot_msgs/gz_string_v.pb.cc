...
void protobuf_AssignDesc_gz_5fstring_5fv_2eproto() {
  ...
  GzString_V_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      -1,
      sizeof(GzString_V),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(GzString_V, _internal_metadata_),
      -1);
}
...
GzString_V* GzString_V::New(::google::protobuf::Arena* arena) const {
  GzString_V* n = new GzString_V;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
// repeated string data = 1;
 int GzString_V::data_size() const {
  return data_.size();
}
 void GzString_V::clear_data() {
  data_.Clear();
}
