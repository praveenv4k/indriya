...
_SONARSTAMPED = _descriptor.Descriptor(
  name='SonarStamped',
  full_name='experimot.msgs.SonarStamped',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='experimot.msgs.SonarStamped.time', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sonar', full_name='experimot.msgs.SonarStamped.sonar', index=1,
