...
_PLANEGEOM = _descriptor.Descriptor(
  name='PlaneGeom',
  full_name='experimot.msgs.PlaneGeom',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='normal', full_name='experimot.msgs.PlaneGeom.normal', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='size', full_name='experimot.msgs.PlaneGeom.size', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='d', full_name='experimot.msgs.PlaneGeom.d', index=2,
