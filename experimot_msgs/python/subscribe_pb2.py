...
_SUBSCRIBE = _descriptor.Descriptor(
  name='Subscribe',
  full_name='experimot.msgs.Subscribe',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='topic', full_name='experimot.msgs.Subscribe.topic', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='host', full_name='experimot.msgs.Subscribe.host', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='port', full_name='experimot.msgs.Subscribe.port', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='msg_type', full_name='experimot.msgs.Subscribe.msg_type', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='latching', full_name='experimot.msgs.Subscribe.latching', index=4,
