...
_PID = _descriptor.Descriptor(
  name='PID',
  full_name='experimot.msgs.PID',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='target', full_name='experimot.msgs.PID.target', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='p_gain', full_name='experimot.msgs.PID.p_gain', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='i_gain', full_name='experimot.msgs.PID.i_gain', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='d_gain', full_name='experimot.msgs.PID.d_gain', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='i_max', full_name='experimot.msgs.PID.i_max', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='i_min', full_name='experimot.msgs.PID.i_min', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='limit', full_name='experimot.msgs.PID.limit', index=6,
