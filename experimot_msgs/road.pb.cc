...
void protobuf_AssignDesc_road_2eproto() {
  ...
  static const int Road_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Road, material_),
  };
  Road_reflection_ =
...
int Road::RequiredFieldsByteSizeFallback() const {
  int total_size = 0;
...
// required string name = 1;
 bool Road::has_name() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
 void Road::set_has_name() {
  _has_bits_[0] |= 0x00000001u;
}
 void Road::clear_has_name() {
  _has_bits_[0] &= ~0x00000001u;
}
 void Road::clear_name() {
  name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_name();
}
 ...
 void Road::set_allocated_name(::std::string* name) {
  if (name != NULL) {
    set_has_name();
  } else {
    clear_has_name();
...
// required double width = 2;
 bool Road::has_width() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
 void Road::set_has_width() {
  _has_bits_[0] |= 0x00000002u;
}
 void Road::clear_has_width() {
  _has_bits_[0] &= ~0x00000002u;
}
 void Road::clear_width() {
  width_ = 0;
  clear_has_width();
}
...
// optional .experimot.msgs.Material material = 4;
 ...
 void Road::set_has_material() {
  _has_bits_[0] |= 0x00000008u;
}
 void Road::clear_has_material() {
  _has_bits_[0] &= ~0x00000008u;
}
