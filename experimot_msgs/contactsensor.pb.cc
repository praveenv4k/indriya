...
void protobuf_AssignDesc_contactsensor_2eproto() {
  ...
  ContactSensor_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ContactSensor, _internal_metadata_),
      -1);
}
...
ContactSensor* ContactSensor::New(::google::protobuf::Arena* arena) const {
  ContactSensor* n = new ContactSensor;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
// optional string collision_name = 1;
 bool ContactSensor::has_collision_name() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
 void ContactSensor::set_has_collision_name() {
  _has_bits_[0] |= 0x00000001u;
}
 void ContactSensor::clear_has_collision_name() {
  _has_bits_[0] &= ~0x00000001u;
}
 void ContactSensor::clear_collision_name() {
  collision_name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
 ...
 void ContactSensor::set_allocated_collision_name(::std::string* collision_name) {
